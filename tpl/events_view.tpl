...
<tr><th>Date-Time</th><th>Description</th><th>Operations</th></tr>
  ...
  <tr class="{{row_class}}">
    <td>
        ...
        <a data-id="{{event.event_id}}" href="#modal-quality" role="button" class="open-modal-comment btn btn-info" data-toggle="modal">Feedback</a>
        </div>
    </td>
...
<!-- Quality Modal -->
  ...
  <div id="modal-quality" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="modal1" aria-hidden="true">
    <form id="modal-form-quality" method="post", action="/events/edit/{{event.event_id}}/script">
    <div class="modal-header">
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
