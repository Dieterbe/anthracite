...
handlers = {
    'add_post_handler_vimeo_engineering': add_post_handler_vimeo_engineering,
    'add_post_handler_vimeo_marketing': add_post_handler_vimeo_marketing,
    'add_post_handler_vimeo_analytics': add_post_handler_vimeo_analytics
}
